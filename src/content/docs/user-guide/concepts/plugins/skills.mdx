...
```typescript
--8<-- "user-guide/concepts/plugins/skills_imports.ts:usage_imports"
...
```typescript
--8<-- "user-guide/concepts/plugins/skills_imports.ts:tools_imports"
...
```typescript
--8<-- "user-guide/concepts/plugins/skills_imports.ts:programmatic_imports"
...
```typescript
--8<-- "user-guide/concepts/plugins/skills_imports.ts:runtime_imports"
...
| Parameter | Type | Default | Description |
|-----------|------|---------|-------------|
| `skills` | `SkillSource[]` | Required | Array of skill sources (paths, HTTPS URLs, `Skill` instances, or a mix). |
